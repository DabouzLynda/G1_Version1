...
class User {
    ...
    SERVER_CREATE_NEW_LIST(client, msg) {
        this.saveState();
        const tdl = new todoListTypes_1.TodoList(msg.name, immutable_1.List(), getNextIdList(), 0, msg.data);
    ...
    SERVER_CREATE_ITEM(client, msg) {
        ...
        const item = new todoListTypes_1.Item(msg.label, msg.checked, Date.now(), getNextIdItem(), 0, msg.data);
